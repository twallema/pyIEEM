...
for country in ['BE', 'SWE']:
    ...
    if country == 'SWE':
        ...
        theta = 0.22*np.array([0, 0, 0, 0, 0, 0, 0.01, 0, 0, 0.01, 0.01, 0.075, 0.01, 0.10, 0.75, 0.025, 0, 0, 0, 0, 0.01])
    else:
        theta = 0.16*np.array([0.75, 0, 0, 3.25, 1.75, 2.00, 0.25, 0, 1.50, 0.25, 0.50]) # "best" fit
