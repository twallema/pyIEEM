...
theta = [24, 0.35, 0.045, 0.035, 0.07, 1, 0.16, -21, 0.20, 14, 7, 7] # where are my parameters? 
mu_list = [24, 0.40, 0, 0.04, 0.07, 1, 0.20, 0, 0.20, 0, 7, 7] # where do I expect the parameters to be?
sigma_list = [1, 0.03, 0.005, 0.004, 0.007, 0.2, 0.03, 7/2, 0.03, 7, 2, 2] # How much noise do I expect there to be on the parameter value?
l_list = [20, 10, 25, 25, 15, 10, 20, 15, 20, 15, 10, 10] # How strong are my beliefs?
