...
class epinomic_model(ODE):
    ...
    parameters_eco = ['x_0', 'c_0', 'f_0', 'l_0', 'IO', 'O_j', 'n', 'on_site', 'C', 'St_0','b','eta','delta_S','theta','iota','kappa_F','kappa_H', 'A', 'prodfunc', 'mu_S']
    ...
    def integrate(t, S, E, Ip, Ia, Im, Ih, R, D, Hin, x, c, c_desired, f, d, l, O, St,
                    ...
                    x_0, c_0, f_0, l_0, IO, O_j, n, on_site, C, St_0, b, eta, delta_S, theta, iota, kappa_F, kappa_H, A, prodfunc, mu_S):
